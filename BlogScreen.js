    ...
    return (
        ...
        >
            <View style={styles.overlay}>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => navigation.navigate('BlogPost')} // Replace with your actual screen name
                >
                    <Text style={styles.buttonText}>Blog Category 1</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => navigation.navigate('BlogPost')} // Replace with your actual screen name
                >
                    <Text style={styles.buttonText}>Blog Category 2</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.button}
                    onPress={() => navigation.navigate('BlogPost')} // Replace with your actual screen name
                >
                    <Text style={styles.buttonText}>Blog Category 3</Text>
                </TouchableOpacity>
            </View>
